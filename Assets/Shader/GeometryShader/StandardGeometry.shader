...
Shader "Standard Geometry Shader Example"
{
    ...
    SubShader
    {
        ...
        // for each Pass object geometry is rendered
        Pass
        {
            Tags { "LightMode"="Deferred" }
            CGPROGRAM
            #pragma target 4.0
            #pragma vertex Vertex                               // tells that code contains vertex Programm in function vert
            #pragma geometry Geometry
            #pragma fragment Fragment                           // same like vertex but for fragment (Pixel)
